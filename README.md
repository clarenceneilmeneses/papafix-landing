...
- **Founders gallery** expects `founder-rai.png`, `founder-clarence.png`, `founder-hanna.png`, `founder-francis.png`, `founder-albert.png` (portrait photos, ~800px wide). Until a file exists, its card shows a monogram placeholder. Albert Molinyawe is Founder & Investor; the other four are co-founders.
